...
4. Configure your products with the required 'sku_guid' metadata for license provisioning.
...
When a customer completes a purchase containing products with 'sku_guid' metadata, the plugin automatically creates licenses through the wp-edenremote system and stores the license reference with the order.
